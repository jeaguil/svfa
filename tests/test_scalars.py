...
def cmp_scalars():
    ...
    distributions = [
        ...
        ("Data after sample-wise L2 normalizing",
         Normalizer().fit_transform(_X_full)),
    ]

    make_plot(8, distributions, features)
...
def plot_distribution(axes, X, hist_nbins=50, title="", x0_label="", x1_label=""):
...
def make_plot(item_indx, distributions, features):
